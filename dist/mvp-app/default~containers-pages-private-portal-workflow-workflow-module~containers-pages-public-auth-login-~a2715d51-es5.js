  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015CheckboxJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_MatCheckboxMixinBase2) {
      ...
      function MatCheckbox(elementRef, _changeDetectorRef, _focusMonitor, _ngZone, tabIndex, _clickAction, _animationMode, _options) {
        ...
        _this3._clickAction = _clickAction;
        ...
        _this3._uniqueId = "mat-checkbox-".concat(++nextUniqueId);
        /**
        ...
        _this3.indeterminateChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
        ...
        */
        ...
        _this3._currentAnimationClass = '';
        _this3._currentCheckState = 0
        /* Init */
        ;

        _this3._controlValueAccessorChangeFn =
        /**
        * @return {?}
        */
        function () {};
        ...
        _this3._options = _this3._options || {};

        if (_this3._options.color) {
          _this3.color = _this3._options.color;
        }

        _this3.tabIndex = parseInt(tabIndex) || 0;

        _this3._focusMonitor.monitor(elementRef, true).subscribe(
        /**
        * @param {?} focusOrigin
        * @return {?}
        */
        ...
        _this3._clickAction = _this3._clickAction || _this3._options.clickAction;
        return _this3;
      }
      /**
...
//# sourceMappingURL=default~containers-pages-private-portal-workflow-workflow-module~containers-pages-public-auth-login-~a2715d51-es5.js.map
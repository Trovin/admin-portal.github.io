...
ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["app-settings"]], decls: 4, vars: 5, consts: [[1, "profile"], [1, "headline"], ["btnContext", "Update", 1, "form", 3, "email", "password", "lastName", "firstName", "selectedItemValue", "registerFormSubmit"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {

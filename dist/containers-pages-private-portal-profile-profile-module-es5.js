...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["containers-pages-private-portal-profile-profile-module"], {
  ...
  function srcAppContainersPagesPrivatePortalProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _containers_common_layers_forms_registration_form_registration_form_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function () {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function update(data) {
          this.authService.update(data.firstName, data.lastName, data.email, data.password, data.selectedAnswer);
        }
      }]);
    ...
    ProfileComponent.ɵfac = function ProfileComponent_Factory(t) {
      return new (t || ProfileComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]));
    };
    ...
    ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 5,
      consts: [[1, "profile"], [1, "headline"], ["btnContext", "Update", 1, "form", 3, "email", "password", "lastName", "firstName", "selectedItemValue", "registerFormSubmit"]],
      template: function ProfileComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("email", ctx.user.email)("password", ctx.user.password)("lastName", ctx.user.lastName)("firstName", ctx.user.firstName)("selectedItemValue", ctx.user.selectedAnswer);
        }
      },

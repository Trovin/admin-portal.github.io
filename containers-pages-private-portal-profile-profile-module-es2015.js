...
class ProfileComponent {
    ...
    update(data) {
        this.authService.update(this.user.id, data.firstName, data.lastName, data.email, data.password, data.selectedCountry, data.registrationDate).subscribe(user => this.user = user);
    }
}

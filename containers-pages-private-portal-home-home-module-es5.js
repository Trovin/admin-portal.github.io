...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["containers-pages-private-portal-home-home-module"], {
  ...
  function node_modulesAngularCdk__ivy_ngcc__Fesm2015TableJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CdkTextColumn_td_2_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        var ctx_r89 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015PaginatorJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MatPaginator_div_2_mat_form_field_3_mat_option_2_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var pageSizeOption_r77 = ctx.$implicit;
    ...
    function MatPaginator_div_2_mat_form_field_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("selectionChange", function MatPaginator_div_2_mat_form_field_3_Template_mat_select_selectionChange_1_listener($event) {
          ...
          return ctx_r78._changePageSize($event.value);
        });
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015SortJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MatSortHeader_div_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("@arrowPosition.start", function MatSortHeader_div_3_Template_div_animation_arrowPosition_start_0_listener() {
          ...
          return ctx_r85._disableViewStateAnimation = true;
          ...
          return ctx_r87._disableViewStateAnimation = false;
        });
    ...
    function (_MatSortHeaderMixinBa) {
      ...
      function MatSortHeader(_intl, changeDetectorRef, _sort, _columnDef, _focusMonitor, _elementRef) {
        ...
        _this19._rerenderSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"])(_sort.sortChange, _sort._stateChanges, _intl.changes).subscribe(
        /**
        * @return {?}
        */
        function () {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015TableJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_angular_cdk_table__W) {
      ...
      function MatTable() {
        ...
        _this20.stickyCssClass = 'mat-table-sticky';
        return _this20;
      }
    ...
    function (_angular_cdk_table__W7) {
      ...
      function MatFooterCell(columnDef, elementRef) {
        ...
        _this22 = _super21.call(this, columnDef, elementRef);
        elementRef.nativeElement.classList.add("mat-column-".concat(columnDef.cssClassFriendlyName));
        return _this22;
      }
    ...
    function (_angular_cdk_table__W8) {
      ...
      function MatCell(columnDef, elementRef) {
        ...
        _this23 = _super22.call(this, columnDef, elementRef);
        elementRef.nativeElement.classList.add("mat-column-".concat(columnDef.cssClassFriendlyName));
        return _this23;
      }
    ...
    function (_angular_cdk_table__W16) {
      ...
      function MatTableDataSource() {
        ...
        _this24._renderData = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]([]);
        /**
         * Stream that emits when a new filter string is set on the data source.
         */

        _this24._filter = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]('');
        /**
         * Used to react to internal changes of the paginator that are made by the data source itself.
         */

        _this24._internalPageChanges = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        /**
         * Subscription to the changes that should trigger an update to the table's rendered rows, such
         * as filtering, sorting, pagination, or base data changes.
         */

        _this24._renderChangesSubscription = rxjs__WEBPACK_IMPORTED_MODULE_4__["Subscription"].EMPTY;
        /**
        ...
        */
        function (data, sort) {
          ...
          */
          function (a, b) {
            /** @type {?} */
            var valueA = _this24.sortingDataAccessor(a, active);
            /** @type {?} */


            var valueB = _this24.sortingDataAccessor(b, active); // If both valueA and valueB exist (truthy), then compare the two. Otherwise, check if
        ...
        */
        ...
        _this24._data = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](initialData);

        _this24._updateChangeSubscription();
      ...
      _createClass(MatTableDataSource, [{
        ...
        value: function _updateChangeSubscription() {
          ...
          */
          function (_ref) {
            ...
            return _this25._filterData(data);
          ...
          */
          function (_ref3) {
            ...
            return _this25._orderData(data);
          ...
          */
          function (data) {
            return _this25._renderData.next(data);
          });
        }
        /**
        ...
        value: function _filterData(data) {
          ...
          */
          function (obj) {
            return _this26.filterPredicate(obj, _this26.filter);
          });
        ...
        value: function _updatePaginator(filteredDataLength) {
          ...
          */
          function () {
            /** @type {?} */
            var paginator = _this27.paginator;
            ...
            if (paginator.pageIndex > 0) {
              ...
              if (newPageIndex !== paginator.pageIndex) {
                ...
                _this27._internalPageChanges.next();
              }
            }
          });
        }
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015TooltipJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _hammerLoader) {
        ...
        */
        function (event) {
          if (_this28._isTooltipVisible() && event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["ESCAPE"] && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["hasModifierKey"])(event)) {
        ...
        */
        function () {
          _elementRef.nativeElement.addEventListener('keydown', _this28._handleKeydown);
        });
      }
      /**
      ...
      _createClass(MatTooltip, [{
        ...
        value: function _createOverlay() {
          ...
          */
          function (change) {
            if (_this30._tooltipInstance) {
              if (change.scrollableViewProperties.isOverlayClipped && _this30._tooltipInstance.isVisible()) {
        ...
        value: function _setupPointerEvents() {
          ...
          if (!this._platform.IOS && !this._platform.ANDROID) {
            ...
            */
            function touchendListener() {
              clearTimeout(_this32._touchstartTimeout);

              _this32.hide(_this32._defaultOptions.touchendHideDelay);
            };
            ...
            */
            function () {
              ...
              clearTimeout(_this32._touchstartTimeout);
              _this32._touchstartTimeout = setTimeout(
              /**
              * @return {?}
              */
              function () {
          ...
          */
          function (listener, event) {
            _this32._elementRef.nativeElement.addEventListener(event, listener, passiveListenerOptions);
          });
        }
        /**
    ...
    function () {
      ...
      _createClass(TooltipComponent, [{
        ...
        value: function show(delay) {
          ...
          */
          function () {
            _this34._visibility = 'visible';
            _this34._showTimeoutId = null; // Mark for check so if any parent component has set the
            // ChangeDetectionStrategy to OnPush it will be checked anyways

            _this34._markForCheck();
          }, delay);
        }
        /**
        ...
        value: function hide(delay) {
          ...
          */
          function () {
            _this35._visibility = 'hidden';
            _this35._hideTimeoutId = null; // Mark for check so if any parent component has set the
            // ChangeDetectionStrategy to OnPush it will be checked anyways
  ...
  /***/
  function srcAppContainersCommonLayersTableWithPaginationTableWithPaginationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TableWithPaginationComponent", function () {
    ...
    function TableWithPaginationComponent_div_12_mat_header_cell_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_cell_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_header_cell_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 28);
    ...
    function TableWithPaginationComponent_div_12_mat_cell_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_header_cell_9_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 28);
    ...
    function TableWithPaginationComponent_div_12_mat_cell_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_header_cell_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 28);
    ...
    function TableWithPaginationComponent_div_12_mat_cell_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_header_cell_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 28);
    ...
    function TableWithPaginationComponent_div_12_mat_cell_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_header_cell_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 28);
    ...
    function TableWithPaginationComponent_div_12_mat_cell_19_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_header_cell_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 28);
    ...
    function TableWithPaginationComponent_div_12_mat_cell_22_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_mat_header_row_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
      }
    }

    function TableWithPaginationComponent_div_12_mat_row_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TableWithPaginationComponent_div_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var TableWithPaginationComponent =
    /*#__PURE__*/
    function () {
      function TableWithPaginationComponent(formBuilder) {
        _classCallCheck(this, TableWithPaginationComponent);

        this.formBuilder = formBuilder;
        this.displayedColumns = ['email', 'firstName', 'lastName', 'address', 'phoneNumber', 'facebookLink', 'registrationDate'];
        this.initForm();
      }

      _createClass(TableWithPaginationComponent, [{
        key: "onSubmit",
    ...
    TableWithPaginationComponent.ɵfac = function TableWithPaginationComponent_Factory(t) {
      return new (t || TableWithPaginationComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"]));
    };

    TableWithPaginationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: TableWithPaginationComponent,
      selectors: [["app-table-with-pagination"]],
      viewQuery: function TableWithPaginationComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 13,
      vars: 3,
      consts: [[1, "item-container"], [1, "item-card__title"], ["novalidate", "", 1, "form", 3, "formGroup", "ngSubmit"], [1, "example-full-width"], ["matInput", "", "formControlName", "filter"], ["mat-flat-button", "", "color", "primary", 1, "filter-btn", 3, "disabled"], [1, "table-headline"], ["class", "table-container", 4, "ngIf"], [1, "table-container"], ["matSort", "", 3, "dataSource"], ["matColumnDef", "email"], ["mat-sort-header", "", 4, "matHeaderCellDef"], ["data-label", "email", 4, "matCellDef"], ["matColumnDef", "firstName"], ["data-label", "firstName", 4, "matCellDef"], ["matColumnDef", "lastName"], ["data-label", "lastName", 4, "matCellDef"], ["matColumnDef", "address"], ["data-label", "address", 4, "matCellDef"], ["matColumnDef", "phoneNumber"], ["data-label", "phoneNumber", "class", "content-right", 4, "matCellDef"], ["matColumnDef", "facebookLink"], ["data-label", "facebookLink", 4, "matCellDef"], ["matColumnDef", "registrationDate"], ["data-label", "registrationDate", "class", "content-right", 4, "matCellDef"], [4, "matHeaderRowDef"], [4, "matRowDef", "matRowDefColumns"], [3, "pageSizeOptions"], ["mat-sort-header", ""], ["data-label", "email"], ["data-label", "firstName"], ["data-label", "lastName"], ["data-label", "address"], ["data-label", "phoneNumber", 1, "content-right"], ["data-label", "facebookLink"], ["data-label", "registrationDate", 1, "content-right"]],
      template: function TableWithPaginationComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function TableWithPaginationComponent_Template_form_ngSubmit_3_listener() {
            return ctx.onSubmit();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TableWithPaginationComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppContainersCommonLayersTableWithPaginationTableWithPaginationModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TableWithPaginationModule", function () {
      return TableWithPaginationModule;
    });
    /* harmony import */
    ...
    var _table_with_pagination_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./table-with-pagination.component */
    "./src/app/containers/common-layers/table-with-pagination/table-with-pagination.component.ts");

    var TableWithPaginationModule = function TableWithPaginationModule() {
      _classCallCheck(this, TableWithPaginationModule);
    };

    TableWithPaginationModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: TableWithPaginationModule
    });
    TableWithPaginationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function TableWithPaginationModule_Factory(t) {
        return new (t || TableWithPaginationModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_3__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TableWithPaginationModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TableWithPaginationModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_table_with_pagination_component__WEBPACK_IMPORTED_MODULE_9__["TableWithPaginationComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_3__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]],
  ...
  function srcAppContainersPagesPrivatePortalHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_task_service_task_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _common_layers_table_with_pagination_table_with_pagination_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../../../common-layers/table-with-pagination/table-with-pagination.component */
    "./src/app/containers/common-layers/table-with-pagination/table-with-pagination.component.ts");
    /* harmony import */
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.stream = this.taskService.getPriorityTasks().subscribe(function (tasks) {
            _this36.tasks = tasks.slice(0, 8);
            _this36.loading = false;
            _this36.chartStats = _this36.chartDataService.composeData(tasks);
          });
        }
      }, {
        key: "ngOnDestroy",
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_task_service_task_service__WEBPACK_IMPORTED_MODULE_5__["TaskService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_compose_chart_service_compose_chart_data_service__WEBPACK_IMPORTED_MODULE_6__["ComposeChartDataService"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 17,
      vars: 11,
      consts: [[1, "home-headline"], [1, "headline-decor"], [1, "grid-container", "home"], [1, "item-card"], [1, "item-card__title"], ["class", "spinner-icon", 3, "diameter", 4, "ngIf"], [3, "type", "text", "values", "labels", "colors"], [1, "task-container"], ["class", "task-item fade-in", 4, "ngFor", "ngForOf"], [3, "items"], [1, "spinner-icon", 3, "diameter"], [1, "task-item", "fade-in"], [1, "task-decoration"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          ...
          type: _services_task_service_task_service__WEBPACK_IMPORTED_MODULE_5__["TaskService"]
        }, {
  ...
  function srcAppContainersPagesPrivatePortalHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _containers_common_layers_table_with_pagination_table_with_pagination_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @containers/common-layers/table-with-pagination/table-with-pagination.module */
    "./src/app/containers/common-layers/table-with-pagination/table-with-pagination.module.ts");
    ...
    HomeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_components_chart_chart_module__WEBPACK_IMPORTED_MODULE_2__["ChartModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _containers_pages_private_portal_home_home_routing_module__WEBPACK_IMPORTED_MODULE_4__["HomeRoutingModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_5__["MatProgressSpinnerModule"], _containers_common_layers_table_with_pagination_table_with_pagination_module__WEBPACK_IMPORTED_MODULE_6__["TableWithPaginationModule"]]]
    });
  ...
  /***/
  function srcAppMocksPortalUsersTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PORTAL_USERS", function () {
      return PORTAL_USERS;
    });

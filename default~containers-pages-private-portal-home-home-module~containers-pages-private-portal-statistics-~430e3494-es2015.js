...
/* harmony import */ var _enums_safe_chart_type_enum__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @enums/safe-chart-type.enum */ "./src/app/enums/safe-chart-type.enum.ts");
/* harmony import */ var _services_app_settings_service_app_settings_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @services/app-settings-service/app-settings.service */ "./src/app/modules/services/app-settings-service/app-settings.service.ts");
...
class ChartComponent {
    ...
    ngOnChanges() {
        ...
        this.stream = this.settingsService.screenSizeObserver
            .subscribe((value) => {
            this.largeScreen = value !== _enums_breakpoint_enum__WEBPACK_IMPORTED_MODULE_2__["Breakpoint"].SM;
            this.renderChart();
        });
    }
    renderChart() {
...
ChartComponent.ɵfac = function ChartComponent_Factory(t) { return new (t || ChartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_app_settings_service_app_settings_service__WEBPACK_IMPORTED_MODULE_5__["AppSettingsService"])); };
ChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ChartComponent, selectors: [["app-chart"]], viewQuery: function ChartComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { type: "type", text: "text", idKey: "idKey", labels: "labels", values: "values", colors: "colors", itemsCount: "itemsCount" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 3, vars: 1, consts: [[3, "hidden"], ["id", "currentId"], ["canvas", ""]], template: function ChartComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChartComponent, [{
    ...
    }], function () { return [{ type: _services_app_settings_service_app_settings_service__WEBPACK_IMPORTED_MODULE_5__["AppSettingsService"] }]; }, { chartRef: [{
...
/* harmony import */ var _chart_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chart.component */ "./src/app/components/chart/chart.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ChartModule, { declarations: [_chart_component__WEBPACK_IMPORTED_MODULE_3__["ChartComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        ng2_charts__WEBPACK_IMPORTED_MODULE_2__["ChartsModule"]], exports: [_chart_component__WEBPACK_IMPORTED_MODULE_3__["ChartComponent"]] }); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "safeChartType", function() { return safeChartType; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ComposeChartDataService", function() { return ComposeChartDataService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


class ComposeChartDataService {
    constructor() {
...
ComposeChartDataService.ɵfac = function ComposeChartDataService_Factory(t) { return new (t || ComposeChartDataService)(); };
ComposeChartDataService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: ComposeChartDataService, factory: ComposeChartDataService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ComposeChartDataService, [{
...
//# sourceMappingURL=default~containers-pages-private-portal-home-home-module~containers-pages-private-portal-statistics-~430e3494-es2015.js.map